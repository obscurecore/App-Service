package ru.ruslan.galleryservice.controller;

import ru.ruslan.galleryservice.exception.BucketNotFoundException;
import ru.ruslan.galleryservice.model.Bucket;
import ru.ruslan.galleryservice.payload.ErrorResponse;
import ru.ruslan.galleryservice.repository.BucketRepository;
...
public class BucketController {
    ...
    public Mono<ResponseEntity<Void>> deleteBucket(@PathVariable(value = "id") String bucketId) {
        ...
        return bucketRepository.findById(bucketId)  // First, search the Bucket you want to delete.
                .flatMap(existingBucket ->
                        bucketRepository.delete(existingBucket)  // Next, delete and return 200 OK to show your delete was successful
